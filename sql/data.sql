...
INSERT INTO historique_ressource (id_ressource, valeur, estEntree, date_historique) VALUES
(1, 10000000,true, '2025-01-01'),
(2, 25000000,true, '2025-03-01'),
(3, 6000000,true, '2025-01-10');

-- Types de prêt
INSERT INTO type_pret (libelle, duree_max, montant_max) VALUES
('Prêt personnel', 12, 5000000), 
('Crédit auto', 12, 30000000);

-- Taux de prêt
INSERT INTO taux_pret (id, id_type_pret, taux_annuel, duree, borne_inf, borne_sup) VALUES
(1, 1, 12.0, 4, 1000, 2000000),      -- Taux 1: Prêt perso de 4 mois à 12%
(2, 1, 9.0, 3, 2000001, 5000000),   -- Taux 2: Prêt perso de 3 mois à 9%
(3, 2, 6.0, 5, 1000000, 15000000);
