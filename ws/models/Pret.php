...
class Pret {
    ...
    public static function create($data) {  
        ...
        try {
            ...
            if (!$id) {
                throw new Exception("Erreur lors de la création du prêt: ID non généré");
            }
            
            // Créer un statut par défaut "En attente"
            ...
            // Retourner les données du prêt créé
    ...
    public static function updateStatut($pretId, $nouveauStatut) {
        ...
        try {
            ...
            if ($stmt->rowCount() === 0) {
                throw new Exception("Prêt non trouvé ou statut déjà à jour");
            }
    ...
    public static function validerPret($pretId) {
        return self::updateStatut($pretId, 'Validé');
    }

    public static function rejeterPret($pretId, $raison = '') {
        return self::updateStatut($pretId, 'Refusé');
    }
}
?>
