...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result && $result['success']) {
        echo json_encode(['success' => true, 'redirect' => '../Pret/list-pret.php']);
    } else {
...
<body>
    <div class="container">
        ...
        <?php endif; ?>
        <form action="http://localhost/ITU/S4/Final-S4-Web/ws/login" method="post">
    ...
    <script>
        document.getElementById('login-form').addEventListener('submit', function(e) {
            ...
            fetch('http://localhost/ITU/S4/Final-S4-Web/ws/login.php', {
                    method: 'POST',
                    body: formData
                })
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        document.getElementById('error-message').textContent = data.error || "Erreur inconnue.";
